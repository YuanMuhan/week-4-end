...
// Add a reactive variable for the friend message
    ...
    <div class="row">
      <div class="col-md-8 offset-md-2">
        ...
        <p class="text-center text-muted">
          <small>3. Change headers.</small> Let's build some more advanced features into our form.
        </p>
        <form @submit.prevent="submitForm">
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <small class="text-muted">2. Move Gender box next to username</small>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-6 col-sm-6">
              ...
              <small class="text-muted">1. Add a confirm password box</small>
              <input
                type="password"
                class="form-control"
                id="confirm-password"
